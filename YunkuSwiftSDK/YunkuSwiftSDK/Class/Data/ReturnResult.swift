...
@objc public class ReturnResult: NSObject {

    internal static let keyCode = "code"
    internal static let keyResult = "return_result"

    public var result: Dictionary<String,AnyObject>!
    public var code = 0
    ...
    public class func create(dic: Dictionary<String,AnyObject>) -> ReturnResult {
